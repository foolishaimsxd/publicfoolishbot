...
class KirkaAPI {
  ...
  async getStats(shortId) {
      try {
          ...
          let req = await fetch(`https://api2.kirka.io/api/wnNWwmW/wWwNnmMW?fields=longId,shortId,name,bio,oldKLO,rankedKLO,level,totalXP,xpSinceLastLevel,xpUntilNextLevel,coins,diamonds,createdAt,clan,stats`, {
              headers: {
                  accept: "application/json, text/plain, */*",
                  "content-type": "application/json;charset=UTF-8",
              },
              body: `{"wwWMNW":"${shortId}","wWWwmMnN":true}`,
              method: "POST",
          });
          ...
          const dataahh = {
              longId: data.wwWMNW,
              shortId: data.wmNwWWMn,
              name: data.wnNWM,
              bio: data.wNmMWwWn,
              oldKLO: data.wNmMWw,
              rankedKLO: data.wWWwmnN,
              level: data.wnWMmw,
              totalXP: data.wmNwMn,
              xpSinceLastLevel: data.wWMnNwW,
              xpUntilNextLevel: data.wWMnNw,
              coins: data.wnWMNm,
              diamonds: data.wmMWwWnN,
              createdAt: data.wWWwmMn,
              clan: data.wnNmWMwW,
              activeWeaponSkin: {
                itemId: data.wWmW.wwWMNW,
                skinType: data.wWmW.wnNWMWmw,
                skinCategory: data.wWmW.wMWWNnwm,
                itemName: data.wWmW.wnNWM,
                baseSkin: {
                    itemId: data.wWmW.wMWWNwmn.wwWMNW,
                    skinType: data.wWmW.wMWWNwmn.wnNWMWmw,
                    skinCategory: data.wWmW.wMWWNwmn.wMWWNnwm,
                    itemName: data.wWmW.wMWWNwmn.wnNWM,
                }
            },
            activeCharacter: {
                itemId: data.wWnmNWM.wwWMNW,
                characterType: data.wWnmNWM.wnNWMWmw,
                characterCategory: data.wWnmNWM.wMWWNnwm,
                itemName: data.wWnmNWM.wnNWM,
            },
              stats: {
                  gamesPlayed: data.wnWMm.wnWMNmw,
                  wins: data.wnWMm.wnNmWwWM,
                  kills: data.wnWMm.wnWMNmwW,
                  deaths: data.wnWMm.wMmnNWwW,
                  headshots: data.wnWMm.wWWwmn,
                  scores: data.wnWMm.wMmnNWw,
              }
          };
  ...
  async pricebvl(skinname) {
    try {
      ...
      return { name: nameOfItem, price: value };
    } catch (e) {
      return e;
    }
  }
